...
public class V1AccessorTest {
    ...
    @Test
    void testParsingArgsWithMinimumRequired() {
        String[] args = {
                "--v1.token=xyz",
                "--v1.url=https://www16.v1host.com/api-examples",
                "--v1.team=Team:1889",
        ...
        assertThat(properties.get("v1.team")).isEqualTo("Team:1889");
        assertThat(properties.get("states")).isEqualTo("Ready for Build, Build, Done");
        assertThat(properties.get("fromClosedDate")).isEqualTo("");
        assertThat(properties.get("includeStoryPoints")).isEqualTo("false");
        assertThat(properties.get("includeTeamName")).isEqualTo("false");
    }
}
